...
const socket = io("http://localhost:5000:5000");
...
function formatOctets(octets = 0) {
  ...
  if (octets < 1_000_000_000_000)
    return `${(octets / 1_000_000_000).toFixed(2)} GB`;
  ...
  return (
    ...
    >
      ...
      >
        ...
        ></span>
        {isConnected
          ? "Socket.io Connected: Receiving Real-time Traffic"
          : "Socket.io Disconnected: Attempting to Reconnect..."}
      </div>
            ...
            {filteredInterfaces.length > 0 ? (
              filteredInterfaces.map((i) => {
                ...
                return (
                  ...
                  >
                    <div>
                      <strong>{i.device_name}</strong> : {i.ifDescr} -{" "}
                      {i.ifAlias}
                      <span
                        style={{
                          marginLeft: 10,
            ...
            >
              ...
              <div style={{ marginBottom: 10 }}>
                ...
                <p style={{ margin: 5, color: "#888", fontSize: 12 }}>
                  RX: {formatOctets(iface?.ifInOctets || 0)} | TX:{" "}
                  {formatOctets(iface?.ifOutOctets || 0)}
                </p>
              </div>
